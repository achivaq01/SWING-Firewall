...
public class Constants {
    ...
    public static Dimension LAUNCH_SIZE = new Dimension(800, 500);
    ...
    public static String MODIFY_RULE_BUTTON_LABEL = "Modify rule";
    public static String DELETE_RULE_BUTTON_LABEL = "Delete rule";
